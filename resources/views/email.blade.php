            ...
            <form action="{{ url('send/mail') }}" method="POST">
                ...
                <div data-aos="zoom-in-up" data-aos-duration="600">
                    <div class="form-group">
                        ...
                        <textarea class="text-area text-box multi-line" name="message" data-val="true" data-val-length="Maximum = 2045 characters" data-val-length-max="2045" id="info" name="info" cols="148" rows="10"></textarea>
                    </div>
                    <div class="form-group">
