                        ...
                        <form action="{{ url('send/reply') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" style="min-width: 100%"
                                ...
                                <div class="d-table-cell w-100">
                                    ...
                                    <textarea class="text-area text-box multi-line" name="message" data-val="true"
                                        data-val-length="Maximum = 2045 characters" data-val-length-max="2045" id="info"
                                        name="info" cols="125" rows="10"></textarea>
                                </div>
